...
import net.avdw.eve.domain.tradeitemgroup.repository.TradeItemGroupByIdSpecification;
import net.avdw.eve.domain.tradeitemgroup.repository.TradeItemGroupByNameSpecification;
import net.avdw.eve.domain.tradeitemgroup.repository.TradeItemGroupLikeNameSpecification;
